    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="{{asset('store/index')}}"><img src="../img/core-img/logo.png" alt=""></a>
                <!-- Navbar Toggler -->
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li><a href="#">Shop</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        ...
                                        <li><a href="{{asset('category/'.$cate->cate_id)}}">{{$cate -> cate_name}}</a></li>
                                        @endforeach
                                    </ul>
                            ...
                            <li><a href="#">Pages</a>
                                   <ul class="dropdown">
                                    <li><a href="{{asset('store/index')}}">Trang Chủ</a></li>
                                    <li><a href="{{asset('store/cua-hang')}}">Cửa Hàng</a></li>
...
-->                                    <li><a href="{{asset('cart/show/')}}">Giỏ Hàng</a></li>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <!-- Cart Area -->
                <div class="cart-area">
                    <a href="#" id="essenceCartBtn"><img src="../img/core-img/bag.svg" alt=""> <span>{{Cart::count()}}</span></a>
                </div>
            </div>
...
<div class="cart-amount-summary">
    ...
    <div class="checkout-btn mt-100">
        <a href="{{asset('cart/show')}}" class="btn essence-btn">Thanh Toán</a>
    </div>
</div>
</div>
</div>
  ...
  <section class="single_product_details_area d-flex align-items-center">
  	...
  	<div class="single_product_thumb clearfix">
        ...
        @foreach($image as $items)
  			<img style="height: 656px" src="{{asset('anh/anhChiTiet/'.$items->image)}}" alt="">
        @endforeach
     ...
     <form class="cart-form clearfix" method="post">
       ...
       <div class="select-box d-flex mt-50 mb-30">
        <select name="select" id="productSize" class="mr-5">
         <option value="value">Size: Liên Hệ</option>
       </select>
       <select name="select" id="productColor">
         <option value="value">Màu Sắc: Liên Hệ</option>
       </select>
     </div>
     <!-- Cart & Favourite Box -->
     <div class="cart-fav-box d-flex align-items-center">
      <!-- Cart -->
      <a href="{{asset('cart/add/'.$product->prod_id)}}" type="submit" name="addtocart" value="5" class="btn essence-btn">Thêm Vào Giỏ Hàng</a>
      <!-- Favourite -->
